...
const STEPS = [
    { key: "personal", title: "Расскажите о себе", subtitle: "Это поможет нам персонализировать ваш опыт" },
    { key: "company", title: "О вашей компании", subtitle: "Последний шаг перед началом работы" },
] as const;
...
export function OnboardingCard() {
    ...
    const handleNext = async () => {
        const fieldsToValidate =
            step === 0 ? (["firstName", "lastName"] as const) : (["companyName", "role"] as const);
        ...
        >
            ...
            <div className="flex gap-3 mt-4">
                ...
                <MainButton
                    ...
                    disabled={isPending}
                    title={isPending ? "Обработка..." : isLastStep ? "Завершить" : "Продолжить"}
            ...
            {!isLastStep && (
                <button
                    ...
                    className="text-center text-sm text-foreground-secondary hover:text-brand-primary transition-colors underline underline-offset-4"
                >
                    Пропустить пока
                </button>
            )}
