...
export function AgentsView() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Привет! Я твой ИИ-ассистент по подбору и анализу кандидатов. Чем могу помочь?',
    },
  ]);
  ...
  return (
    <div className="relative w-full h-[calc(100vh-175px)] max-w-5xl mx-auto px-4 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between pb-2 mb-2 border-b border-border shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold tracking-tight text-foreground m-0 leading-tight">ИИ Агент-рекрутер</h1>
            <p className="text-[11px] text-muted-foreground m-0">Работает в реальном времени</p>
          </div>
        </div>
      </div>
